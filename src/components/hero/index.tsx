    ...
    <div className="relative w-full sm:h-[650px] h-[500px] overflow-hidden">
      ...
      <motion.div
       ...
       whileInView={{
        ...
        className={`absolute inset-0 w-full bg-center bg-cover top-12  transition-transform duration-[2s] ease-out ${
        ...
        <div className="container mx-auto px-6 pt-24 md:pt-28">
          <div className="max-w-xl">
            ...
            <motion.h1
              ...
              className="text-white text-3xl lg:text-6xl md:text-5xl font-bold leading-[1.1] mb-8"
            >
              The Best Day &<br />
              Night Cruises In
              <br />
